              ...
              <table id="simple-example-table" class="table table-hover table-condensed table-hover" >
                                        ...
                                        <th width="12%">Tipo de daño</th>
                                         ...
                                         <tr>
                                             ...
                                             <% if ( rol == 1 ){ %>
                                              <td><a href="IncidenteCtrlr?accion=eliminar&serial=<%out.print(incidentes.getIdincidente()); %>"><boton class="btn btn btn-danger" title="Realmente desea eliminar a =<%out.print(incidentes.getIdincidente());%>"><center>Eiminar</center></boton></a></td>
                                              <% } %>
                                              <% if( rol == 1 | rol == 2  ){ %>
                                              <td><a href="IncidenteCtrlr?accion=Modificar&serial=<%out.print(incidentes.getIdincidente()); %>"> <boton class="btn btn-success"><center>Modificar</center></boton> </a></td>
                                              <td><a href="IncidenteCtrlr?accion=Solucion&serial=<%out.print(incidentes.getIdincidente()); %>"> <boton class="btn btn-success"><center>Solucion</center></boton> </a></td>
                                                <% } %>
