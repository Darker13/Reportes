...
<nav>
   ...
   <br>
     <br>
            ...
            inc= (ArrayList) request.getSession().getAttribute("pendiente");
            %>
                                        ...
                                        <th width="12%">Tipo de daño</th>
                                         ...
                                         <tr>
                                             ...
                                             <td><%out.print(incidentes.getDescripcion()); %></td>
                                              <td><a href="IncidenteCtrlr?accion=Modificar&serial=<%=incidentes.getIdincidente() %>"> <boton class="btn btn-success"><center>Asignar</center></boton> </a></td>
